...
class ColorDetection:
    ...
    def __init__(self):
        ...
        self.pub_roi = rospy.Publisher('exit/roi', CameraInfo, queue_size=1)
        self.pub_img= rospy.Publisher('exit/image', Image, queue_size=1)
        self.sub_camera_info = rospy.Subscriber('/realsense_plugin/color/camera_info',
                CameraInfo, self.camera_info_callback)
        self.sub_camera = rospy.Subscriber('/realsense_plugin/color/image_raw',
    ...
    def image_callback(self, msg):
        ...
        # Skip far recognized object. samller width and size of a rect means the object is far away
